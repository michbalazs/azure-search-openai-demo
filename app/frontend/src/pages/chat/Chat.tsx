...
import { EmojiSparkleFilled } from "@fluentui/react-icons";
                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            <EmojiSparkleFilled fontSize={"120px"} primaryFill={"rgba(18, 59, 182, 1)"} aria-hidden="true" aria-label="Chat logo" />
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Type a new question (e.g. What is etrackr and why should i use it?)"
                            disabled={isLoading}
