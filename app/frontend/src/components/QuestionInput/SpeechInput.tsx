            ...
            {!isRecording && (
                <div className={styles.questionInputButtonsContainer}>
                    <Tooltip content="Ask question with voice" relationship="label">
                        <Button size="large" icon={<Mic28Filled primaryFill="rgba(18, 59, 182,1)" />} onClick={startRecording} />
                    </Tooltip>
                </div>
            )}
            {isRecording && (
                <div className={styles.questionInputButtonsContainer}>
                    <Tooltip content="Stop recording question" relationship="label">
                        <Button size="large" icon={<Mic28Filled primaryFill="rgba(18, 59, 182,0.7)" />} disabled={!isRecording} onClick={stopRecording} />
                    </Tooltip>
                </div>
            )}
        </>
